...
<div class="card"><div class="chartHead"><b>TradingView Stock Screener</b><span class="hint">Market scanner</span></div><div class="tabs"><button id="usScreen" class="pill">NASDAQ / US</button><button id="inScreen" class="pill">NSE / India</button></div><div id="tvscreener" style="height:520px"></div></div><div class="card"><div class="chartHead"><b>Ichimoku Scanner</b><span class="hint">App strategy</span></div><div id="scanner" class="watch"></div></div>
